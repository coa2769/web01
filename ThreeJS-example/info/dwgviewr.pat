...
;;
;;  Version 2.0
;;  DWG TrueView Hatch Patterns
;;
;;
;;  Note: in order to ease migration of this file when upgrading 
;;  to a future version of DWG TrueView, it is recommended that you add
...
;;  upgrading to a future DWG TrueView version.  If duplicate hatch
